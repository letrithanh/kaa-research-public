...
//	private static final Logger LOG = LoggerFactory.getLogger(FanApplication.class);
	...
	public static void main(String[] args) {
		light = new Light();
		System.out.println("=============================================================");
		System.out.println("Status of Light:");
...
//				LOG.info("Message: " + notification.getMessage());
				...
				controlLight(notification.getMessage());
                inputTopicIdMessage();
			}
        });
...
//        LOG.info("\nPlease, type topic ID in order to subscribe to ones or type any text to exit: \n");
    ...
    private static List<Topic> getOneTypeTopics(SubscriptionType type) {
        ...
        for (Topic t : LightApplication.topics) {
    ...
    private static void controlLight(String message) {
    	System.out.println("=============================================================");
		System.out.println("Status of Light:");
		System.out.println(light.toString());
		System.out.println("=============================================================");
