...
//	private static final Logger LOG = LoggerFactory.getLogger(AirConditionerApplication.class);
	...
	public static void main(String[] args) {
		...
		System.out.println("=============================================================");
		System.out.println("Status of Conditioner:");
...
//				LOG.info("Message: " + notification.getMessage());
				...
				controlAirConditioner(notification.getMessage());
                inputTopicIdMessage();
			}
        });
...
//        LOG.info("\nPlease, type topic ID in order to subscribe to ones or type any text to exit: \n");
    ...
    private static List<Topic> getOneTypeTopics(SubscriptionType type) {
        ...
        for (Topic t : AirConditionerApplication.topics) {
    ...
    private static void controlAirConditioner(String message) {
